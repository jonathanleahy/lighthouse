resource "aws_iam_policy" "console_audit_bff_sns_policy" {
...
resource "aws_iam_role_policy_attachment" "app_sns_policy_attach" {
  role       = aws_iam_role.console_audit_bff_role.name
  policy_arn = aws_iam_policy.console_audit_bff_sns_policy.arn
}
